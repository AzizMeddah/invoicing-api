...
export class CabinetService {
  ...
  async findOneById(id: number): Promise<CabinetEntity> {
    const cabinet = await (
      ...
      .leftJoinAndSelect('cabinet.logo', 'logo')
      .leftJoinAndSelect('cabinet.signature', 'signature')
  ...
  async update(
    ...
    const logo=await this.storageService.findOneById(updateCabinetDto.logoId)
    const signature=await this.storageService.findOneById(updateCabinetDto.signatureId)
